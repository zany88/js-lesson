...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "46078402fe1952867ed3";
...
/* harmony import */ var snabbdom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
/* harmony import */ var snabbdom_modules_style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
...
/* harmony import */ var snabbdom_modules_eventlisteners__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
/* harmony import */ var snabbdom_modules_eventlisteners__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(snabbdom_modules_eventlisteners__WEBPACK_IMPORTED_MODULE_3__);
// import $ from 'jquery'
...
var patch = Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["init"])([snabbdom_modules_style__WEBPACK_IMPORTED_MODULE_2___default.a, snabbdom_modules_eventlisteners__WEBPACK_IMPORTED_MODULE_3___default.a]);
var data = {
  selected: undefined,
  movies: [{
    rank: 1,
...
var data1 = ['Sort by:', 'Rank', 'Title', 'Description'];
var app = document.querySelector('#app');

function setVnode(data) {
  return Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div#container', [Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('h1', 'Top 10 movies'), Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.top-head', [Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.top-left', {}, data1.map(function (i) {
    return Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.top-one', {
      on: {
        click: [oneFun, i]
      }
    }, i);
  })), Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.top-right', {
    on: {
      click: add
    }
  }, 'Add')]), Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.content', {}, data.movies.map(function (i) {
    return Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.col', {}, [Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.itemid', i.rank), Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.itemtitle', i.title), Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.item', i.desc), Object(snabbdom__WEBPACK_IMPORTED_MODULE_0__["h"])('div.cha', {
      on: {
        click: [del, i]
      }
    }, 'x')]);
...
var old = render(app, setVnode(data));

function oneFun(item) {
  var ms = data;

  if (item === 'Title') {
    ms.movies.sort(function (a, b) {
    ...
    ms.movies.sort(function (a, b) {
      return a.desc.toLowerCase().charCodeAt(0) - b.desc.toLowerCase().charCodeAt(0);
    });
  }
...
function del(item) {
  ...
  for (var i = 0; i < ms.movies.length; i++) {
...
/* harmony import */ var _vnode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _is__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _htmldomapi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _h__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "h", function() { return _h__WEBPACK_IMPORTED_MODULE_3__["h"]; });

/* harmony import */ var _thunk__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
...
/* harmony import */ var _h__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
